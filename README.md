...
<p>I'm Artem, Fullstack developer from Krasnodar, Russia. I have 9 years of commercial development experience. 
<br/>Now I am the Development Team Lead at Kaspersky Lab.</p>
...
const artem = {
    age          : 29,
    country      : "Russia",
    code         : ["Node.js", "Javascript", "Typescript", "React"],
    about        : ["Developer", "Lead coder", "Development Team Lead"],
    technologies : {
        backEnd  : ["Node.js", "Express", "NestJS"],
        frontEnd : ["JavaScript", "Typescript", "React", "React Native" "Next.js"],
        databases: ["MySQL", "PostgreSQL", "SQlite", "Redis", "ClickHouse"],
        misc     : ["Electron", "UIWebView"]
    },
    os           : ["MacOS", "Linux"],
